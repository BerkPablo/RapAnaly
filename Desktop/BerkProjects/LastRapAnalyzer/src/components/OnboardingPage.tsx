                    ...
                    <div className="glass-card" style={{ padding: "1.5rem", background: "rgba(255,255,255,0.02)" }}>
                        ...
                        <div className="grid grid-cols-1 gap-6 text-xs text-muted" style={{ color: "var(--text-muted)" }}>
                            ...
                            <div>
                                ...
                                <ul className="space-y-1">
                                    <li><strong className="text-primary">AvgDiff (Bias):</strong> Average of <code>(MLM Value - Pro Value)</code>. Indicates systematic error (high or low).</li>
                                    <li><strong className="text-primary">AvgAbsDiff:</strong> Average of <code>|MLM Value - Pro Value|</code>. The average magnitude of error.</li>
